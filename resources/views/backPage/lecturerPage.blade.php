        ...
        <div class="py-12 bg-gray-200 bg-opacity-80 transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0 hidden" id="modalEdit" aria-hidden="true">
            <div role="alert" class="container mx-auto w-11/12 md:w-2/3 max-w-lg">
                ...
                <div class="relative bg-white rounded-lg shadow ">
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        <h3 class="mb-4 text-xl font-medium text-slate-600 text-center">Validasi</h3>
                        <form class="space-y-6" action="" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div>
                                <label for="NamaKegiatan" class="block mb-2 text-sm font-medium text-slate-500 ">Nama Kegiatan</label>
                                <input type="text" name="namaKegiatan" id="namaKegiatan" class="bg-gray-200 border text-slate-400 text-sm rounded-lg focus:ring-gray-700 focus:border-gray-700 block w-full p-2.5 " readonly>
                            </div>
                            <div>
                                <label for="kategori" class="block mb-2 text-sm font-medium text-slate-500 ">Kategori Kegiatan</label>
                                <input type="text" name="kategori" id="kategori" class="bg-gray-200 border text-slate-400 text-sm rounded-lg focus:ring-gray-700 focus:border-gray-700 block w-full p-2.5 " readonly>
                            </div>
                            <div>
                                <label for="instansi" class="block mb-2 text-sm font-medium text-slate-500 ">Instansi Penyelenggara</label>
                                <input type="text" name="instansi" id="instansi" class="bg-gray-200 border text-slate-400 text-sm rounded-lg focus:ring-gray-700 focus:border-gray-700 block w-full p-2.5 " readonly>
                            </div>
                            <div>
                                <label for="tglKegiatan" class="block mb-2 text-sm font-medium text-slate-500 ">Tanggal Kegiatan</label>
                                <input type="date" name="tglKegiatan" id="tglKegiatan" class="bg-gray-200 border text-slate-400 text-sm rounded-lg focus:ring-gray-700 focus:border-gray-700 block w-full p-2.5 " readonly>
                            </div>
                            <div>
                                <label for="tglKegiatan" class="block mb-2 text-sm font-medium text-slate-500 ">Semester</label>
                                <input type="number" name="semester" id="semester" class="bg-gray-200 border text-slate-400 text-sm rounded-lg focus:ring-gray-700 focus:border-gray-700 block w-full p-2.5 " readonly>
                            </div>
                            <div>
                                <label for="bukti" class="block mb-2 text-sm font-medium text-slate-500 ">Upload Bukti</label>
                                <input type="text" name="bukti" id="bukti" class="bg-gray-200 border text-slate-400 text-sm rounded-lg focus:ring-gray-700 focus:border-gray-700 block w-full p-2.5 " readonly>
                            </div>

                            <button type="button" class=" w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="submit">Validasi</button>
                    ...
                    <table class="w-full text-sm text-left text-slate-500 " id="myTabl">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b">
                                ...
                                <td class="py-4 px-6">dads</td>
                                <td class="py-4 px-6">Nasional</td>
                                <td class="py-4 px-6">Undiksha</td>
                                <td class="py-4 px-6">12-12-2012</td>
                            ...
                            <tr class="bg-white border-b">
                                <th scope="row" class="py-4 px-6 font-medium whitespace-nowrap text-slate-400">2</th>
                                <td class="py-4 px-6">Andre</td>
                                <td class="py-4 px-6">3</td>
                                <td class="py-4 px-6">MLBB</td>
                                <td class="py-4 px-6">Nasional</td>
                                <td class="py-4 px-6">Undiksha</td>
                                <td class="py-4 px-6">12-12-2012</td>
                                <td class="py-4 px-6"><a href="#" class="underline">Lihat Bukti</a></td>
                                <td class="py-4 px-6 text-green-500 font-semibold">Divalidasi</td>
                                <td class="py-4 px-6 font-semibold">
                            ...
                            <tr class="bg-white border-b">
                                <th scope="row" class="py-4 px-6 font-medium whitespace-nowrap text-slate-400">3</th>
                                <td class="py-4 px-6">Jilong</td>
                                <td class="py-4 px-6">3</td>
                                <td class="py-4 px-6">PUBG Competition</td>
                                <td class="py-4 px-6">Nasional</td>
                                <td class="py-4 px-6">Undiksha</td>
                                <td class="py-4 px-6">12-12-2012</td>
                                <td class="py-4 px-6"><a href="#" class="underline">Lihat Bukti</a></td>
                                <td class="py-4 px-6 text-red-500 font-semibold">Ditolak</td>
                                <td class="py-4 px-6 font-semibold">
                                    <form action="" method="Post">
